package com.barops.backend.core.config;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtAuthenticationConverter jwtAuthenticationConverter, JwtAuthenticationFilter jwtAuthenticationFilter) {
